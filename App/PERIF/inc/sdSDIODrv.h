...
//#define SD_DETECT_PIN                    GPIO_Pin_6                 /* PF.11 */
//#define SD_DETECT_GPIO_PORT              GPIOC                       /* GPIOF */
//#define SD_DETECT_GPIO_CLK               RCC_APB2Periph_GPIOC

  #define SD_DAT3_PORT                         GPIOC  
  #define SD_DAT3_PORT_PIN                     GPIO_Pin_11
  #define RCC_APB2Periph_GPIO_SD_DAT3          RCC_APB2Periph_GPIOC
...
/** 
  ...
  */
#define SDIO_TRANSFER_CLK_DIV            ((uint8_t)0x1)   // in USB MASS STORAGE
//#define SDIO_TRANSFER_CLK_DIV            ((uint8_t)0x00)  - in SDIO example with FAT_FS 
